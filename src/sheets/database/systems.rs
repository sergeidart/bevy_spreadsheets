...
use crate::sheets::events::{
    MigrationCompleted, MigrationProgress, RequestExportSheetToJson, RequestMigrateJsonToDb,
    RequestUploadJsonToCurrentDb, SheetOperationFeedback,
};
...
pub struct MigrationBackgroundState {
    ...
    pub completion_rx:
        Option<Arc<Mutex<Receiver<Result<(super::migration::MigrationReport, PathBuf), String>>>>>, // final result with db path
...
pub fn handle_migration_requests(
    ...
    for event in events.read() {
        ...
        let (tx_done, rx_done) =
            channel::<Result<(super::migration::MigrationReport, PathBuf), String>>();
