...
use super::parent_key_helpers::{get_ancestor_columns, get_primary_display_column, resolve_text_row_index_by_meta, RowUpdates};
...
fn process_table_batches(
    ...
    for batch_idx in 0..num_batches {
        ...
        if !rows_to_update.is_empty() {
            ...
            daemon_client.exec_batch(statements, None)
