                ...
                ui.horizontal(|ui| {
                    ...
                    egui::containers::popup::popup_below_widget(
                        ...
                        |popup_ui| {
                            ...
                            let char_w = 8.0_f32;
                            let max_name_len =
                                all_sheet_names.iter().map(|s| s.len()).max().unwrap_or(12);
                            ...
                            egui::ScrollArea::vertical().max_height(300.0).show(
                                ...
                                |list_ui| {
                                    if list_ui
                                        .selectable_label(
                                            state.options_link_target_sheet.is_none(),
                                            "--Select--",
                                        )
                                        .clicked()
                                    {
                                    ...
                                    for name in all_sheet_names.iter() {
                                        ...
                                        if list_ui
                                            .selectable_label(
                                                state.options_link_target_sheet.as_deref()
                                                    == Some(name.as_str()),
                                                name,
                                            )
                                            .clicked()
                    ...
                    ui.add_enabled_ui(state.options_link_target_sheet.is_some(), |ui| {
                        ...
                        egui::containers::popup::popup_below_widget(
                            ...
                            |popup_ui| {
                                ...
                                let char_w = 8.0_f32;
                                let max_name_len =
                                    headers.iter().map(|(_, h)| h.len()).max().unwrap_or(12);
                                let padding = 24.0_f32;
                                let mut popup_min_width = (max_name_len as f32) * char_w + padding;
                                if popup_min_width < 120.0 {
                                    popup_min_width = 120.0;
                                ...
                                popup_ui.horizontal(|ui_h| {
                                    ...
                                    let resp = ui_h.add(
                                        egui::TextEdit::singleline(&mut filter_text)
                                            .desired_width(width)
                                            .hint_text("type to filter columns"),
                                    );
                                    if resp.changed() {
                                        ui_h.memory_mut(|mem| {
                                            mem.data.insert_temp(
                                ...
                                egui::ScrollArea::vertical().max_height(300.0).show(
                                    ...
                                    |list_ui| {
                                        if list_ui
                                            .selectable_label(
                                                state.options_link_target_column_index.is_none(),
                                                "--Select--",
                                            )
                                            .clicked()
                                        {
            ...
            ValidatorTypeChoice::Structure => {
                ...
                if existing_is_structure {
                    ...
                    if let Some(meta) = meta_opt {
                        ...
                        if state.options_existing_structure_key_parent_column
                            != current_key_effective
                        {
                            state.options_existing_structure_key_parent_column =
                                current_key_effective;
                        }
                        ...
                        ui.horizontal(|ui_h| {
                            ...
                            let combo_id = format!(
                                "key_parent_column_selector_internal_{}_{}",
                                state
                                    .options_column_target_category
                                    .as_deref()
                                    .unwrap_or(""),
                            ...
                            egui::containers::popup::popup_below_widget(
                                ...
                                |popup_ui| {
                                    ...
                                    let char_w = 8.0_f32;
                                    let max_name_len =
                                        headers.iter().map(|h| h.len()).max().unwrap_or(12);
                                    let padding = 24.0_f32;
                                    let mut popup_min_width =
                                        (max_name_len as f32) * char_w + padding;
                                    if popup_min_width < 120.0 {
                                        popup_min_width = 120.0;
                                    }
                                    if popup_min_width > 900.0 {
                                    ...
                                    popup_ui.horizontal(|ui_h2| {
                                        ...
                                        if ui_h2.small_button("x").clicked() {
                                            filter_text.clear();
                                            ui_h2.memory_mut(|mem| {
                                                mem.data.insert_temp(
                                                    filter_key.clone().into(),
                            ...
                            if current_key.is_some() {
                                if ui_h.small_button("x").on_hover_text("Clear key").clicked() {
                                    current_key = None;
                                }
                            }
                        ...
                        ui.label(
                            "Key column is context-only (sent first to AI) and not overwritten.",
                        );
                    }
                } else {
                    ...
                    if let Some(meta) = meta_opt {
                        ...
                        let headers: Vec<String> =
                            meta.columns.iter().map(|c| c.header.clone()).collect();
                        ui.horizontal(|ui_k| {
                            ...
                            let sel_text = temp_choice
                                .and_then(|i| headers.get(i))
                                .cloned()
                                .unwrap_or_else(|| "(none)".to_string());
                            let combo_id = format!(
                                "new_structure_key_parent_col_internal_{}_{}",
                                state
                                    .options_column_target_category
                                    .as_deref()
                                    .unwrap_or(""),
                            ...
                            egui::containers::popup::popup_below_widget(
                                ...
                                |popup_ui| {
                                    ...
                                    egui::ScrollArea::vertical().max_height(300.0).show(
                                        ...
                                        |list_ui| {
                                            if list_ui
                                                .selectable_label(temp_choice.is_none(), "(none)")
                                                .clicked()
                                            {
                                                temp_choice = None;
                                                list_ui.memory_mut(|mem| mem.close_popup());
                                            ...
                                            for (i, h) in headers.iter().enumerate() {
                                                if i == state.options_column_target_index {
                                                    continue;
                                                }
                                                if !current_filter.is_empty()
                                                    && !h.to_lowercase().contains(&current_filter)
                                                ...
                                                if list_ui
                                                    .selectable_label(temp_choice == Some(i), h)
                                                    .clicked()
                                                {
                                                    temp_choice = Some(i);
                                                    list_ui.memory_mut(|mem| mem.close_popup());
