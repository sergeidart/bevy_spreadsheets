...
use crate::ui::elements::popups::{
    show_ai_rule_popup, show_column_options_popup, show_delete_category_confirm_popups,
    show_delete_confirm_popup, show_new_category_popup, show_new_sheet_popup,
    show_random_picker_popup, show_rename_popup, show_settings_popup, show_validator_confirm_popup,
};
...
pub(super) fn display_active_popups(
    ...
    show_new_sheet_popup(
        ...
        Some(&mut sheet_writers.upload_req),
    );
